...
ZZ RSA::Potencia_Modulo1(ZZ p, ZZ e, ZZ n)
{
    if (e == 0) return ZZ(1);
    ...
    for (long i = k - 1; i >= 0; i--) {
        SqrMod(res, res, n);
        if (bit(e, i) == 1) MulMod(res, res, p, n);
    }
...
int main()
{
    RSA a;
    //a.Cifrar("R");
    //cout << "sol.velasquez@ucsp.edu.pe = ";


    cout << a.Potencia_Modulo1(ZZ(499827560), ZZ(244394099), ZZ(626264131)) << endl;
    cout << a.Exponenciacion_modular(ZZ(499827560), ZZ(244394099), ZZ(626264131)) << endl;

    cout << a.Potencia_Modulo1(ZZ(499827), ZZ(244394), ZZ(626264)) << endl;
    cout << a.Exponenciacion_modular(ZZ(499827), ZZ(244394), ZZ(626264)) << endl;

    cout << a.Potencia_Modulo1(ZZ(49982), ZZ(24439), ZZ(6262)) << endl;
    cout << a.Exponenciacion_modular(ZZ(49982), ZZ(24439), ZZ(6262)) << endl;

    cout << a.Potencia_Modulo1(ZZ(499), ZZ(244), ZZ(626)) << endl;
    cout << a.Exponenciacion_modular(ZZ(499), ZZ(244), ZZ(626)) << endl;
